"""
Django settings for roscoe-thanksgiving project.
...
ROOT_URLCONF = 'roscoe-thanksgiving.urls'
...
WSGI_APPLICATION = 'roscoe-thanksgiving.wsgi.application'
...
AWS_STORAGE_BUCKET_NAME = 'roscoethanksgiving'
