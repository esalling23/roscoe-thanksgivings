...
This template contains a project, `roscoe-thanksgiving`, and an app, `api`,
...
1. Replace all instances of `roscoe-thanksgiving` with your application name. **This includes the folder included in this repository.**
...
This template includes a project `roscoe-thanksgiving` which should be renamed
...
all instances of `roscoe-thanksgiving` with your app's name.
